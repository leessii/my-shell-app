...
- Build date: 2024-02-05T19:03:44.797206696+01:00[Europe/Vienna]
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        defaultClient.setBasePath("https://www.boredapi.com:443/api");
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**activityGet**](docs/DefaultApi.md#activityGet) | **GET** /activity | Get events by type
